/**
 * https://www.hackerearth.com/practice/algorithms/dynamic-programming/introduction-to-dynamic-programming-1/practice-problems/algorithm/maze-5/description/
 */
...
class EasyMazeProblem {
	...
	public static void main(String[] args) throws IOException {
		...
		Vector<HashSet<Integer>> possibleDoors = new Vector<HashSet<Integer>>();
			
		HashSet<Integer> groundFloor = new HashSet<Integer>();
		groundFloor.add(b);
		possibleDoors.add(groundFloor);
		
		for (int i = 0; i < m; i++) {
		    HashSet<Integer> prev = possibleDoors.get(i);
